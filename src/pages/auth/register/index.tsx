...
export default function Register() {
    return (
        <div style={{
            ...
            <div style={{
                background: 'linear-gradient(to bottom, #c2d0e1 50%, #5c7477 50%)'
            }} className="h-11/12 w-3/4 max-w-5xl flex overflow-hidden shadow-[0_0_20px_20px_rgba(0,0,0,0.6),0_10px_80px_rgba(0,0,0,0.6)]">
                {/* Left side - Form */}
                <div className="bg-white h-full w-1/2 flex flex-col align-center px-16 border-tl rounded-r-3xl">
                    <div className="mb-2">
                        <h1 className="text-3xl font-bold text-gray-800 mb-5 mt-10">Sign Up your account</h1>
                    </div>
                    ...
                    <p className="text-sm text-gray-600 text-center mt-2">
                        Already have an account? <Link href="./login" className="text-blue-600 hover:text-blue-700 font-semibold hover:underline">Sign in</Link>
                    </p>
