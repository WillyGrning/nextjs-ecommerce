...
export default function LoginView({ handleSubmit, loading }: LoginViewProps) {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    if (isValid && !loading) handleSubmit(e, email, password);
  };
  ...
  return (
    <div className="min-h-screen w-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 flex items-center justify-center p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-yellow-400/5 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative w-full max-w-6xl flex flex-col lg:flex-row items-center gap-8 lg:gap-0">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center">
          <div className="w-full max-w-md">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <input
                        ...
                        className={`w-full px-4 py-3 md:py-4 text-base bg-gray-50 border-2 ${
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <button
                        ...
                        className="absolute right-4 top-1/2 cursor-pointer -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors"
                      >
                        {showPassword ? (
            ...
            <div
              className="absolute -bottom-4 -right-4 w-24 h-24 bg-pink-400/20 rounded-full blur-xl animate-pulse pointer-events-none"
